...
#low_order_method1 = LobattoQuadrature(5)
#high_order_method1 = LobattoQuadrature(7)


G7K15 = G7K15Quadrature()
low_order_method1 = G7K15.get_G7()
high_order_method1 = G7K15.get_K15()

# Adaptive Quadrature Class
ad1 = AdaptiveQuadrature(low_order_method1, high_order_method1, min_h=1e-02, method_order_difference=12.86, variable_h=True)
...
low_order_method2 = GaussLegendreQuadrature(5)
high_order_method2 = GaussLegendreQuadrature(7)

# Adaptive Quadrature Class
ad2 = AdaptiveQuadrature(low_order_method2, high_order_method2)
...
for i in range(m.size):
	...
	I1, n1 = ad1.adaptive_quadrature(f, a, b, tol=10.0**(-m[i]), maxit=1000, output=False)
	...
	#I2, n2	= lobatto_adaptive_quadrature(f, a, b, 10.0**(-m[i])) #, output=True)
	I2, n2 = ad2.adaptive_quadrature(f, a, b, tol=10.0**(-m[i]), maxit=1000, output=False)
