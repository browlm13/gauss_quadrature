...
def G7K15(a, b):
	...
	# K
	x0  = -0.991455371120813 #0.5*(a+b) + 0.5*(b-a)*(-0.991455371120813)
	x1  = 0.991455371120813 #0.5*(a+b) + 0.5*(b-a)*( 0.991455371120813)
	# GK
	x2  = -0.949107912342759 #0.5*(a+b) + 0.5*(b-a)*(-0.949107912342759)
	x3  = 0.949107912342759 #0.5*(a+b) + 0.5*(b-a)*( 0.949107912342759)
	# K
	x4  = -0.864864423359769 #0.5*(a+b) + 0.5*(b-a)*(-0.864864423359769)
	x5  = 0.864864423359769 #0.5*(a+b) + 0.5*(b-a)*( 0.864864423359769)
	# GK
	x6  = -0.741531185599394 #0.5*(a+b) + 0.5*(b-a)*(-0.741531185599394)
	x7  = 0.741531185599394 #0.5*(a+b) + 0.5*(b-a)*( 0.741531185599394)
	# K
	x8  = -0.586087235467691 #0.5*(a+b) + 0.5*(b-a)*(-0.586087235467691)
	x9  = 0.586087235467691 #0.5*(a+b) + 0.5*(b-a)*( 0.586087235467691)
	# GK
	x10 = -0.405845151377397 #0.5*(a+b) + 0.5*(b-a)*(-0.405845151377397)
	x11 = 0.405845151377397 #0.5*(a+b) + 0.5*(b-a)*( 0.405845151377397)
	# K
	x12 = -0.207784955007898 #0.5*(a+b) + 0.5*(b-a)*(-0.207784955007898)
	x13 = 0.207784955007898 #0.5*(a+b) + 0.5*(b-a)*( 0.207784955007898)
	# GK
	x14 = 0.000000000000000 #0.5*(a+b) + 0.5*(b-a)*( 0.000000000000000)
